...
public class ChatEntre2Clients {
    ...
    private void creationClient() throws IOException {
        ...
        Thread envoyer = new Thread( () -> {
            while(true){
                ...
                try {
                    out.println(new String(getAes().encodeString(InetAddress.getLocalHost().getHostAddress() + " >> " + msg), StandardCharsets.ISO_8859_1));
                    out.flush();
                }
                catch (UnknownHostException e) {
                    e.printStackTrace();
            ...
            try {
                ...
                while(msg!=null){
                    if(receptKey) {
                        ...
                        msg = getAes().decodeBytes(msg.getBytes(StandardCharsets.ISO_8859_1));
        ...
        try {
            ...
            Thread envoi = new Thread( () -> {
                while(true){
                    ...
                    try {
                        out.println(new String(aes.encodeString(InetAddress.getLocalHost().getHostAddress() + " >> " + msg), StandardCharsets.ISO_8859_1));
                        out.flush();
                    }
